...
class Airplane {
  ...
  */
  ...
  /*
    TASK 1
      - Write a Person class whose constructor initializes `name` and `age` from arguments. ---> constructor needs name-> age, this.name=name this.age= age
  ...
  /*
    TASK 3
      ...
      - Instances of Lambdasian should be able to `.speak()`:
          ...
          + {name} and {location} of course come from the instansce's own properties.
  */
 class Lambdasian {
    constructor(attrs){
 ...
 const personTwo = new Instructor({
  name:'Gabby',
  age: 27,
  location:'NYC'
})
  ...
  /*
    TASK 6
      ...
      - ProjectManager instances have the following methods:
          + `standUp` a method that takes in a slack channel and returns `{name} announces to {channel}, @channel standy times!`//PASSES
 ...
 const personFour = new ProjectManager({
  name:'Britt',
  age: 25,
  location:'Toronto'
})
